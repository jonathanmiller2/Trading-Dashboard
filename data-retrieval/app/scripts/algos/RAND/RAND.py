...
if (now.hour < 9) or (now.hour == 9 and now.minute < 30) or (now.hour > 16):
    ...
    for asset in assets:   
        ...
        if r > 0.95 and cash_balance > 0:
            ...
            print_and_log("Algo %s trading from dollars to %s shares of %s" % (ALGO_NAME, amount_bought, asset[0]))
            ...
            print_and_log("Algo %s trading from %s shares to %s dollars" % (ALGO_NAME, asset[0], amount_bought))
